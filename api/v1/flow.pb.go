...
var file_api_v1_flow_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xf0, 0x01, 0x0a, 0x04, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x22, 0x0a, 0x0c, 0x77, 0x6f,
	...
	0x61, 0x6d, 0x65, 0x1a, 0x4f, 0x0a, 0x09, 0x44, 0x61, 0x74, 0x61, 0x45, 0x6e, 0x74, 0x72, 0x79,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xc9, 0x02, 0x0a, 0x0a, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x73,
	...
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x1a, 0x4f,
	...
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xbc, 0x01, 0x0a, 0x0b, 0x54, 0x61, 0x73,
	0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2f, 0x0a, 0x0b, 0x53, 0x61, 0x76, 0x65,
	0x54, 0x61, 0x73, 0x6b, 0x44, 0x65, 0x66, 0x12, 0x08, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x44, 0x65,
	0x66, 0x1a, 0x14, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x44, 0x65, 0x66, 0x53, 0x61, 0x76, 0x65, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x21, 0x0a, 0x04, 0x50, 0x6f, 0x6c,
...
var file_api_v1_flow_proto_depIdxs = []int32{
	7, // 0: Task.data:type_name -> Task.DataEntry
	8, // 1: TaskResult.data:type_name -> TaskResult.DataEntry
	0, // 2: TaskResult.status:type_name -> TaskResult.Status
	9, // 3: Task.DataEntry.value:type_name -> google.protobuf.Value
	9, // 4: TaskResult.DataEntry.value:type_name -> google.protobuf.Value
	3, // 5: TaskService.SaveTaskDef:input_type -> TaskDef
	5, // 6: TaskService.Poll:input_type -> TaskPollRequest
	5, // 7: TaskService.PollStream:input_type -> TaskPollRequest
	2, // 8: TaskService.Push:input_type -> TaskResult
	4, // 9: TaskService.SaveTaskDef:output_type -> TaskDefSaveResponse
	1, // 10: TaskService.Poll:output_type -> Task
	1, // 11: TaskService.PollStream:output_type -> Task
